...
class Mathematics extends Component {
    render() {
        return (
            <div class='ma-body'>
                <div class='ma-top-bar w-full flex pt-12'>
                    ...
                    <div class='ma-title pt-2 w-1/2'>
                        <p class='font-[Mulish] font-semibold text-[24px] leading-[27.41px]'>Mathematics</p>
                        <p class='mt-2 font-["M_PLUS_Rounded_1c"] text-[#313848] font-bold text-[14px] leading-[15.29px] opacity-50'>16 ChapterCards / 140 Lessons</p>
                    </div>
                    <div class='search-box w-1/2 z-10'>
                        ...
                        <div class="relative w-full">
                            ...
                            <input type="text" id="simple-search" class="z-10 w-[500px] h-[48px] top-[16px] left-[40.41px] border border-1.5 border-gray-300 bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-[40px] focus:ring-blue-500 focus:border-blue-500 block w-full pl-10 p-2.5  dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500 md:w-[340px] xl:w-[500px]" placeholder="Search for a lesson or topic" required />
                        </div>
                    </div>
                    <div class='fixed top-[-16px] right-[0px] z-0'>
                ...
                <div class='ma-container p-12'>
                    <div class='resume-learning pt-4'>
                        <p class='font-bold text-[18px] font-["M_PLUS_Rounded_1c"] leading-[19.66px] tracking-[0.2px]' >Resume learning</p>
                        <div class='resume-class rounded-lg w-[495px] h-[105px] bg-[#EA7052] mt-4 flex items-center'>
                            <div class='w-1/4 pl-8'>
                                <svg width="67" height="70" viewBox="0 0 67 70" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <path d="M59.465 46.089C41.8882 48.8852 25.2646 48.8852 7.68458 46.089C5.49321 45.7403 3.80957 43.987 3.50494 41.8002C1.92283 30.3842 1.92283 18.8052 3.50494 7.38588C3.80957 5.19914 5.49321 3.44583 7.68458 3.09713C25.2613 0.300958 41.8849 0.300958 59.465 3.09713C61.6563 3.44583 63.34 5.19914 63.6446 7.38588C65.2267 18.8019 65.2267 30.3809 63.6446 41.8002C63.34 43.987 61.6563 45.7403 59.465 46.089Z" fill="#F9AD6D" stroke="black" stroke-width="1.31846" />
                                    <path d="M26.665 11.7884V36.351C26.665 37.3873 27.8442 37.9902 28.6893 37.3873L45.9713 25.1044C46.6854 24.596 46.6854 23.5401 45.9713 23.0317L28.6893 10.7488C27.841 10.1459 26.665 10.7488 26.665 11.7851V11.7884Z" fill="white" stroke="black" stroke-width="1.31846" />
                                    ...
                                    <path d="M26.665 11.7884V36.351C26.665 37.3873 27.8442 37.9902 28.6893 37.3873L45.9713 25.1044C46.6854 24.596 46.6854 23.5401 45.9713 23.0317L28.6893 10.7488C27.841 10.1459 26.665 10.7488 26.665 11.7851V11.7884Z" stroke="black" stroke-width="1.31846" />
                                    <path d="M2.89957 59.2462H63.7041C64.7569 59.2462 65.6045 60.4226 65.6045 61.8825C65.6045 63.3425 64.7569 64.5201 63.7041 64.5201H2.89957C1.84677 64.5201 1 63.3437 1 61.8825C1 60.4214 1.84763 59.2462 2.89957 59.2462Z" fill="#F9AD6D" stroke="black" stroke-width="1.31846" />
                                    <path d="M16.3885 55.2911H18.3733C19.7484 55.2911 20.8555 56.3982 20.8555 57.7721V66.7074C20.8555 68.0825 19.7484 69.1885 18.3733 69.1885H16.3885C15.0134 69.1885 13.9062 68.0825 13.9062 66.7074V57.7721C13.9062 56.3971 15.0134 55.2911 16.3885 55.2911Z" fill="#67BD99" stroke="black" stroke-width="1.31846" />
                                </svg>
                            </div>
                            <div class='resume-desc w-2/4 text-white font-["M_PLUS_Rounded_1c"] leading-[19.66px] tracking-[0.2px] font-semobold text-center'>
                                <p class='text-[16px]'>Properties of Plane Shpaes</p>
                                <p class='text-[14px]'>You've watched 3 of 7 lessons</p>
                            </div>
                            <div class='bg-opacity-25 pt-[18px] pl-[16px] bg-white rounded-[50px] w-[50px] h-[50px] items-center  items-center ml-[35px]'>
                                <div class='m-auto'>
                                    <svg  width="18" height="12" viewBox="0 0 18 12" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        <path d="M11.7856 11.4184L16.9999 6.42857L11.7856 1" stroke="white" stroke-width="1.5" stroke-miterlimit="10" stroke-linejoin="round" />
                                        <path d="M0.672852 6.10205L16.9994 6.10205" stroke="white" stroke-width="1.5" stroke-miterlimit="10" stroke-linejoin="round" />
                                    </svg>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class='chapter-container pt-6 w-full mt-4'>
                        <p class='font-bold text-[18px] font-["M_PLUS_Rounded_1c"] leading-[19.66px] tracking-[0.2px]' >All ChapterCards</p>
