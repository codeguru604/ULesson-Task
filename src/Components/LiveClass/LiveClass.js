        ...
        <div className='live-class'>
            <div className='banner' style={{ backgroundColor: bannerColor }}>
                <div className='banner-picture'>
                    <img src={imageUrl} alt="svg"></img>
                </div>
                <div className='banner-label'>
                    {labelName === 'live' ? (
                        <div className='label'>
                            <div className='label-tag' style={{ backgroundColor: '#DA0000', width: '83px' }}>
                            ...
                            <div className='five-dots'>
                                <img src='/5-dots.png' alt='5 dots'></img>
                            </div>

                        </div>
                    ) : (labelName === 'replay' ? (
                        <div className='label'>
                            <div className='label-tag' style={{ backgroundColor: '#F2984D', width: '68px' }}>
                                <svg width="10" height="12" viewBox="0 0 10 12" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <g clipPath="url(#clip0_48_6047)">
                        ...
                        <div className='label'>
                            <div className='label-tag' style={{ backgroundColor: '#606572', width: '95px' }}>
            ...
            <div className="card-description">
                <p className='class-type' style={{ color: bannerColor }}>{classType}</p>
                ...
                {labelName === 'replay' ? (
                    <div className='card-time'>
                        <svg width="11" height="14" viewBox="0 0 11 14" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path d="M1.94604 1.00012V3.41249C1.94604 5.30184 3.47766 6.83345 5.36701 6.83345V6.83345V6.83345C7.25636 6.83345 8.78798 5.30183 8.78798 3.41249V1.00012" stroke="#313848" strokeLinecap="round" strokeLinejoin="round" />
                            <path d="M1.94604 12.6667V10.2544C1.94604 8.36503 3.47766 6.83342 5.36701 6.83342V6.83342V6.83342C7.25636 6.83342 8.78798 8.36504 8.78798 10.2544V12.6667" stroke="#313848" strokeLinecap="round" strokeLinejoin="round" />
                            <path d="M0.804443 1.00012H9.92702" stroke="#313848" strokeLinecap="round" />
                            <path d="M0.804443 12.6667H9.92702" stroke="#313848" strokeLinecap="round" />
                        </svg>
                        <p>{startTime}</p>
                    </div>
                ) : (
