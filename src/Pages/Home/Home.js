...
const lessonTypes = ['MATHEMATICS', 'ENGLISH LANGUAGE', 'CHEMISTRY', 'BIOLOGY', 'PHYSICS', 'ECONOMICS', 'ACCOUNTING', 'LITERATURE IN ENGLISH', 'GOVERNMENT'];
...
const Home = () => {
    ...
    const bgColor = selectedColor === 'PRIMARY 2' ? '#BEC6DA' : '#DAAAAA';
    const style = 'bg-[' + bgColor + '] home w-full';
    return (
        <div class={style}>
            <div class='top-bar w-full h-[100px] border-b border-gray-300 p-6 items-center flex'>
                <div class='left-bar w-3/4 float-lef'>
                    ...
                    <div class="relative w-full">
                        ...
                        <input type="text" id="simple-search" class="w-[532px] h-[48px] top-[16px] left-[40.41px] border border-1.5 border-gray-300 rounded-lg bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block pl-10 p-2.5  dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="What would you like to learn?" required />
                    </div>
                </div>
                <div class="style-button relative z-1 w-1/8 p-6">
                    <button id="dropdown-button" data-dropdown-toggle="dropdown-list" class="style-btn bg-gray-900 text-white flex w-[150px] h-[38px] top-[24px] left-[1309px] p-4 items-center rounded-lg gap-4 font-[Mulish] text-[14px] font-semibold leading-[14px] tracking-[1px] text-left " type="button" onClick={toggleDropdown}>
                        {selectedColor}
                        <svg width="12" height="8" viewBox="0 0 12 8" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path d="M6.1073 7.85742L0.490079 0.638672L11.7245 0.638673L6.1073 7.85742Z" fill="white" />
                        </svg>
                    </button>
                    <div id="dropdown-list" class={`${isOpen ? '' : 'hidden'} bg-white z-10 fixed top-[70px]`}>
